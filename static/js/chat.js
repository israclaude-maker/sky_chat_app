...
function showOngoingCall() {
  ...
  // Mobile call controls fix
  if (window.innerWidth <= 768) {
    setTimeout(function () {
      var ctrl = document.querySelector('#ongoing-call .call-controls');
      if (ctrl) {
        ...
        style.textContent = '#ongoing-call .call-controls::-webkit-scrollbar{display:none!important}' +
          '#ongoing-call .call-controls .ctrl-btn{flex-shrink:0!important;width:48px!important;height:48px!important}' +
          '#ongoing-call .call-controls .ctrl-btn.end{flex-shrink:0!important;width:56px!important;height:56px!important}';
